#    obj/CodeGenerator/Python/headers/BluetoothHeader.py
#    Created 27/07/2023 at 10:10:45 from:
#        Messages = messages/headers/BluetoothHeader.yaml
...
class BluetoothHeader :
    ...
    #@staticmethod
    #def Create() :
    #    message_buffer = ctypes.create_string_buffer(BluetoothHeader.SIZE)
    ...
    def __init__(self, messageBuffer=None):
        ...
        if messageBuffer == None:
            doInit = 1
            messageBuffer = ctypes.create_string_buffer(BluetoothHeader.SIZE)
        else:
            try:
                messageBuffer.raw
    ...
    def GetFunctionBlock(self, enumAsInt=0):
        """"""
        value = struct.unpack_from('B', self.rawBuffer(), BluetoothHeader.MSG_OFFSET + 0)[0]
        if not enumAsInt:
            value = BluetoothHeader.ReverseFunctionBlocks.get(value, value)
        return value
    ...
    def GetFunction(self):
        """"""
        value = struct.unpack_from('B', self.rawBuffer(), BluetoothHeader.MSG_OFFSET + 1)[0]
        return value
    ...
    def GetPackedField(self):
        """"""
        value = struct.unpack_from('B', self.rawBuffer(), BluetoothHeader.MSG_OFFSET + 2)[0]
        return value
    ...
    def GetOperator(self, enumAsInt=0):
        ...
        if not enumAsInt:
            value = BluetoothHeader.ReverseOperators.get(value, value)
        return value
    ...
    def GetDataLength(self):
        """"""
        value = struct.unpack_from('B', self.rawBuffer(), BluetoothHeader.MSG_OFFSET + 3)[0]
        return value
    ...
    def SetFunctionBlock(self, value):
        ...
        value = BluetoothHeader.FunctionBlocks.get(value, defaultValue)
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), BluetoothHeader.MSG_OFFSET + 0, tmp)
    ...
    def SetFunction(self, value):
        """"""
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), BluetoothHeader.MSG_OFFSET + 1, tmp)
    ...
    def SetPackedField(self, value):
        """"""
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), BluetoothHeader.MSG_OFFSET + 2, tmp)
    ...
    def SetOperator(self, value):
        ...
        if isinstance(value, int) or value.isdigit():
            defaultValue = int(value)
        value = BluetoothHeader.Operators.get(value, defaultValue)
    ...
    def SetDataLength(self, value):
        """"""
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), BluetoothHeader.MSG_OFFSET + 3, tmp)
