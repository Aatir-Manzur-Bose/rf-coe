#    obj/CodeGenerator/Python/headers/NetworkHeader.py
...
class NetworkHeader :
    ...
    #@staticmethod
    #def Create() :
    #    message_buffer = ctypes.create_string_buffer(NetworkHeader.SIZE)
    ...
    def __init__(self, messageBuffer=None):
        ...
        if messageBuffer == None:
            doInit = 1
            messageBuffer = ctypes.create_string_buffer(NetworkHeader.SIZE)
        else:
            try:
                messageBuffer.raw
    ...
    def SetMessageID(self, id):
        ...
        id = id >> 8
        self.SetExtraIDBits(id & 0xfff)

    def GetMessageID(self):
        id = ((((((self.GetExtraIDBits())<<8)+self.GetFunctionBlock(1))<<8)+self.GetFunction())<<4)+self.GetOperator(1)
        return id
    ...
    @msg.size('2')
    @msg.count(1)
    def GetExtraIDBits(self):
        """"""
        value = struct.unpack_from('>H', self.rawBuffer(), NetworkHeader.MSG_OFFSET + 0)[0]
        return value
    ...
    def GetFunctionBlock(self, enumAsInt=0):
        """"""
        value = struct.unpack_from('B', self.rawBuffer(), NetworkHeader.MSG_OFFSET + 2)[0]
        if not enumAsInt:
            value = NetworkHeader.ReverseFunctionBlocks.get(value, value)
        return value
    ...
    def GetFunction(self):
        """"""
        value = struct.unpack_from('B', self.rawBuffer(), NetworkHeader.MSG_OFFSET + 3)[0]
        return value
    ...
    def GetPackedField(self):
        """"""
        value = struct.unpack_from('B', self.rawBuffer(), NetworkHeader.MSG_OFFSET + 4)[0]
        return value
    ...
    def GetOperator(self, enumAsInt=0):
        ...
        if not enumAsInt:
            value = NetworkHeader.ReverseOperators.get(value, value)
        return value
    ...
    def GetDataLength(self):
        """"""
        value = struct.unpack_from('B', self.rawBuffer(), NetworkHeader.MSG_OFFSET + 5)[0]
        return value
    ...
    def GetTime(self):
        """"""
        value = struct.unpack_from('>L', self.rawBuffer(), NetworkHeader.MSG_OFFSET + 6)[0]
        return value
    ...
    @msg.size('2')
    @msg.count(1)
    def SetExtraIDBits(self, value):
        """"""
        tmp = min(max(value, 0), 65535)
        struct.pack_into('>H', self.rawBuffer(), NetworkHeader.MSG_OFFSET + 0, tmp)
    ...
    def SetFunctionBlock(self, value):
        ...
        value = NetworkHeader.FunctionBlocks.get(value, defaultValue)
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), NetworkHeader.MSG_OFFSET + 2, tmp)
    ...
    def SetFunction(self, value):
        """"""
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), NetworkHeader.MSG_OFFSET + 3, tmp)
    ...
    def SetPackedField(self, value):
        """"""
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), NetworkHeader.MSG_OFFSET + 4, tmp)
    ...
    def SetOperator(self, value):
        ...
        if isinstance(value, int) or value.isdigit():
            defaultValue = int(value)
        value = NetworkHeader.Operators.get(value, defaultValue)
    ...
    def SetDataLength(self, value):
        """"""
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), NetworkHeader.MSG_OFFSET + 5, tmp)
    ...
    def SetTime(self, value):
        ...
        struct.pack_into('>L', self.rawBuffer(), NetworkHeader.MSG_OFFSET + 6, tmp)
    

    # Reflection information
    fields = [ \
        FieldInfo(name="ExtraIDBits",type="int",units="",minVal="0",maxVal="65535",description="",get=GetExtraIDBits,set=SetExtraIDBits,count=1, idbits=12,bitfieldInfo = [], enum = []),\
        ...
        FieldInfo(name="Time",type="int",units="ms",minVal="0",maxVal="4294967295",description="",get=GetTime,set=SetTime,count=1, bitfieldInfo = [], enum = [])\
    ]
