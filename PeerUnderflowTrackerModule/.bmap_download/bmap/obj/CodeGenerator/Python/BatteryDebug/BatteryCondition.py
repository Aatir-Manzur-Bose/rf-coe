#    obj/CodeGenerator/Python/BatteryDebug/BatteryCondition.py
#    Created 27/07/2023 at 10:09:46 from:
#        Messages = messages/BatteryDebug/BatteryCondition.yaml
...
class BatteryDebug_BatteryCondition_Get :
    ID = 103345
    SIZE = 0
    MSG_OFFSET = Messaging.hdrSize
    # Enumerations
    IDs = OrderedDict([("FunctionBlock", 25), ("Function", 59), ("Operator", 1)])
    ReverseIDs = OrderedDict([(25, "FunctionBlock"), (59, "Function"), (1, "Operator")])
    
    
    #@staticmethod
    #def Create():
    #    message_buffer = ctypes.create_string_buffer(BatteryDebug_BatteryCondition_Get.MSG_OFFSET + BatteryDebug_BatteryCondition_Get.SIZE)
    #
    #    Messaging.hdr.SetMessageID(message_buffer, BatteryDebug_BatteryCondition_Get.ID)
    #    Messaging.hdr.SetDataLength(message_buffer, BatteryDebug_BatteryCondition_Get.SIZE)
    #
    ...
    def __init__(self, messageBuffer=None):
        ...
        if messageBuffer == None:
            doInit = 1
            messageBuffer = ctypes.create_string_buffer(BatteryDebug_BatteryCondition_Get.MSG_OFFSET + BatteryDebug_BatteryCondition_Get.SIZE)
        else:
            try:
                messageBuffer.raw
        ...
        if doInit:
            self.hdr.SetMessageID(BatteryDebug_BatteryCondition_Get.ID)
            self.hdr.SetDataLength(BatteryDebug_BatteryCondition_Get.SIZE)
            self.initialize()
    ...
    @staticmethod
    def MsgName():
        return "BatteryDebug.BatteryCondition.Get"
    # Accessors
...
Messaging.Register("BatteryDebug.BatteryCondition.Get", BatteryDebug_BatteryCondition_Get.ID, BatteryDebug_BatteryCondition_Get)
#    obj/CodeGenerator/Python/BatteryDebug/BatteryCondition.py
#    Created 27/07/2023 at 10:09:46 from:
#        Messages = messages/BatteryDebug/BatteryCondition.yaml
#        Template = Template.py
...
class BatteryDebug_BatteryCondition_Status :
    ID = 103347
    SIZE = 4
    MSG_OFFSET = Messaging.hdrSize
    # Enumerations
    IDs = OrderedDict([("FunctionBlock", 25), ("Function", 59), ("Operator", 3)])
    ReverseIDs = OrderedDict([(25, "FunctionBlock"), (59, "Function"), (3, "Operator")])
    
    
    #@staticmethod
    #def Create():
    #    message_buffer = ctypes.create_string_buffer(BatteryDebug_BatteryCondition_Status.MSG_OFFSET + BatteryDebug_BatteryCondition_Status.SIZE)
    #
    #    Messaging.hdr.SetMessageID(message_buffer, BatteryDebug_BatteryCondition_Status.ID)
    #    Messaging.hdr.SetDataLength(message_buffer, BatteryDebug_BatteryCondition_Status.SIZE)
    #
    #    return message_buffer
    ...
    def __init__(self, messageBuffer=None):
        ...
        if messageBuffer == None:
            doInit = 1
            messageBuffer = ctypes.create_string_buffer(BatteryDebug_BatteryCondition_Status.MSG_OFFSET + BatteryDebug_BatteryCondition_Status.SIZE)
        else:
            try:
                messageBuffer.raw
            except AttributeError:
        ...
        self.hdr = Messaging.hdr(messageBuffer)
        if doInit:
            self.hdr.SetMessageID(BatteryDebug_BatteryCondition_Status.ID)
            self.hdr.SetDataLength(BatteryDebug_BatteryCondition_Status.SIZE)
            self.initialize()
    ...
    @staticmethod
    def MsgName():
        return "BatteryDebug.BatteryCondition.Status"
    # Accessors
    @msg.units('')
    @msg.default('')
    @msg.minVal('0')
    ...
    def GetConditionBits(self):
        ...
        value = struct.unpack_from('>L', self.rawBuffer(), BatteryDebug_BatteryCondition_Status.MSG_OFFSET + 0)[0]
        return value
    ...
    def SetConditionBits(self, value):
        ...
        struct.pack_into('>L', self.rawBuffer(), BatteryDebug_BatteryCondition_Status.MSG_OFFSET + 0, tmp)
...
Messaging.Register("BatteryDebug.BatteryCondition.Status", BatteryDebug_BatteryCondition_Status.ID, BatteryDebug_BatteryCondition_Status)
