#    obj/CodeGenerator/Python/SensorInterface/Buttons.py
#    Created 27/07/2023 at 10:11:03 from:
#        Messages = messages/SensorInterface/Buttons.yaml
...
class SensorInterface_Buttons_Get :
    ID = 98513
    SIZE = 0
    MSG_OFFSET = Messaging.hdrSize
    # Enumerations
    IDs = OrderedDict([("FunctionBlock", 24), ("Function", 13), ("Operator", 1)])
    ReverseIDs = OrderedDict([(24, "FunctionBlock"), (13, "Function"), (1, "Operator")])
    
    
    #@staticmethod
    #def Create():
    #    message_buffer = ctypes.create_string_buffer(SensorInterface_Buttons_Get.MSG_OFFSET + SensorInterface_Buttons_Get.SIZE)
    #
    #    Messaging.hdr.SetMessageID(message_buffer, SensorInterface_Buttons_Get.ID)
    #    Messaging.hdr.SetDataLength(message_buffer, SensorInterface_Buttons_Get.SIZE)
    #
    ...
    def __init__(self, messageBuffer=None):
        ...
        if messageBuffer == None:
            doInit = 1
            messageBuffer = ctypes.create_string_buffer(SensorInterface_Buttons_Get.MSG_OFFSET + SensorInterface_Buttons_Get.SIZE)
        else:
            try:
                messageBuffer.raw
        ...
        if doInit:
            self.hdr.SetMessageID(SensorInterface_Buttons_Get.ID)
            self.hdr.SetDataLength(SensorInterface_Buttons_Get.SIZE)
            self.initialize()
    ...
    @staticmethod
    def MsgName():
        return "SensorInterface.Buttons.Get"
    # Accessors
...
Messaging.Register("SensorInterface.Buttons.Get", SensorInterface_Buttons_Get.ID, SensorInterface_Buttons_Get)
#    obj/CodeGenerator/Python/SensorInterface/Buttons.py
#    Created 27/07/2023 at 10:11:03 from:
#        Messages = messages/SensorInterface/Buttons.yaml
#        Template = Template.py
...
class SensorInterface_Buttons_SetGet :
    ID = 98514
    SIZE = 5
    MSG_OFFSET = Messaging.hdrSize
    # Enumerations
    ...
    IDs = OrderedDict([("FunctionBlock", 24), ("Function", 13), ("Operator", 2)])
    ReverseIDs = OrderedDict([(24, "FunctionBlock"), (13, "Function"), (2, "Operator")])
    
    
    #@staticmethod
    #def Create():
    #    message_buffer = ctypes.create_string_buffer(SensorInterface_Buttons_SetGet.MSG_OFFSET + SensorInterface_Buttons_SetGet.SIZE)
    #
    #    Messaging.hdr.SetMessageID(message_buffer, SensorInterface_Buttons_SetGet.ID)
    #    Messaging.hdr.SetDataLength(message_buffer, SensorInterface_Buttons_SetGet.SIZE)
    #
    #    return message_buffer
    ...
    def __init__(self, messageBuffer=None):
        ...
        if messageBuffer == None:
            doInit = 1
            messageBuffer = ctypes.create_string_buffer(SensorInterface_Buttons_SetGet.MSG_OFFSET + SensorInterface_Buttons_SetGet.SIZE)
        else:
            try:
                messageBuffer.raw
            except AttributeError:
        ...
        self.hdr = Messaging.hdr(messageBuffer)
        if doInit:
            self.hdr.SetMessageID(SensorInterface_Buttons_SetGet.ID)
            self.hdr.SetDataLength(SensorInterface_Buttons_SetGet.SIZE)
            self.initialize()
    ...
    @staticmethod
    def MsgName():
        return "SensorInterface.Buttons.SetGet"
    # Accessors
    @msg.units('')
    @msg.default('')
    @msg.minVal('0')
    ...
    def GetType(self, enumAsInt=0):
        """Button press type."""
        value = struct.unpack_from('B', self.rawBuffer(), SensorInterface_Buttons_SetGet.MSG_OFFSET + 0)[0]
        if not enumAsInt:
            value = SensorInterface_Buttons_SetGet.ReverseButtonPressType.get(value, value)
        return value
    ...
    def GetButtons(self, enumAsInt=0):
        ...
        value = struct.unpack_from('B', self.rawBuffer(), SensorInterface_Buttons_SetGet.MSG_OFFSET + 1)[0]
        if not enumAsInt:
            value = SensorInterface_Buttons_SetGet.ReverseButtonID.get(value, value)
        return value
    ...
    def GetButtonGroup(self):
        ...
        value = struct.unpack_from('B', self.rawBuffer(), SensorInterface_Buttons_SetGet.MSG_OFFSET + 2)[0]
        return value
    ...
    def GetButtonDisable(self):
        ...
        value = struct.unpack_from('B', self.rawBuffer(), SensorInterface_Buttons_SetGet.MSG_OFFSET + 3)[0]
        return value
    ...
    def GetInternalState(self):
        ...
        value = struct.unpack_from('B', self.rawBuffer(), SensorInterface_Buttons_SetGet.MSG_OFFSET + 4)[0]
        return value
    ...
    def GetInternalStateValue(self, enumAsInt=0):
        ...
        if not enumAsInt:
            value = SensorInterface_Buttons_SetGet.ReverseInternalState.get(value, value)
        return value
    ...
    def SetType(self, value):
        ...
        value = SensorInterface_Buttons_SetGet.ButtonPressType.get(value, defaultValue)
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), SensorInterface_Buttons_SetGet.MSG_OFFSET + 0, tmp)
    ...
    def SetButtons(self, value):
        ...
        if isinstance(value, int) or value.isdigit():
            defaultValue = int(value)
        value = SensorInterface_Buttons_SetGet.ButtonID.get(value, defaultValue)
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), SensorInterface_Buttons_SetGet.MSG_OFFSET + 1, tmp)
    ...
    def SetButtonGroup(self, value):
        """0 == earbud Master or non-earbud product; 1 == earbud Puppet"""
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), SensorInterface_Buttons_SetGet.MSG_OFFSET + 2, tmp)
    ...
    def SetButtonDisable(self, value):
        """1 == Disable button module, button module will not respond to any button commands except sending BMAP status response; 0 == Enable button module."""
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), SensorInterface_Buttons_SetGet.MSG_OFFSET + 3, tmp)
    ...
    def SetInternalState(self, value):
        """internal state used to process this button"""
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), SensorInterface_Buttons_SetGet.MSG_OFFSET + 4, tmp)
    ...
    def SetInternalStateValue(self, value):
        ...
        if isinstance(value, int) or value.isdigit():
            defaultValue = int(value)
        value = SensorInterface_Buttons_SetGet.InternalState.get(value, defaultValue)
...
Messaging.Register("SensorInterface.Buttons.SetGet", SensorInterface_Buttons_SetGet.ID, SensorInterface_Buttons_SetGet)
#    obj/CodeGenerator/Python/SensorInterface/Buttons.py
#    Created 27/07/2023 at 10:11:03 from:
#        Messages = messages/SensorInterface/Buttons.yaml
#        Template = Template.py
...
class SensorInterface_Buttons_Status :
    ID = 98515
    SIZE = 7
    MSG_OFFSET = Messaging.hdrSize
    # Enumerations
    ...
    ButtonID = OrderedDict([("Power", 1), ("MFB", 2), ("VolumeUp", 4), ("VolumeDown", 8), ("VPA", 16), ("ANR_CNC", 32), ("Captouch", 64)])
    ReverseButtonID = OrderedDict([(1, "Power"), (2, "MFB"), (4, "VolumeUp"), (8, "VolumeDown"), (16, "VPA"), (32, "ANR_CNC"), (64, "Captouch")])
    IDs = OrderedDict([("FunctionBlock", 24), ("Function", 13), ("Operator", 3)])
    ReverseIDs = OrderedDict([(24, "FunctionBlock"), (13, "Function"), (3, "Operator")])
    
    
    #@staticmethod
    #def Create():
    #    message_buffer = ctypes.create_string_buffer(SensorInterface_Buttons_Status.MSG_OFFSET + SensorInterface_Buttons_Status.SIZE)
    #
    #    Messaging.hdr.SetMessageID(message_buffer, SensorInterface_Buttons_Status.ID)
    #    Messaging.hdr.SetDataLength(message_buffer, SensorInterface_Buttons_Status.SIZE)
    #
    #    return message_buffer
    ...
    def __init__(self, messageBuffer=None):
        ...
        if messageBuffer == None:
            doInit = 1
            messageBuffer = ctypes.create_string_buffer(SensorInterface_Buttons_Status.MSG_OFFSET + SensorInterface_Buttons_Status.SIZE)
        else:
            try:
                messageBuffer.raw
            except AttributeError:
        ...
        self.hdr = Messaging.hdr(messageBuffer)
        if doInit:
            self.hdr.SetMessageID(SensorInterface_Buttons_Status.ID)
            self.hdr.SetDataLength(SensorInterface_Buttons_Status.SIZE)
            self.initialize()
    ...
    @staticmethod
    def MsgName():
        return "SensorInterface.Buttons.Status"
    # Accessors
    @msg.units('')
    @msg.default('')
    @msg.minVal('0')
    ...
    def GetType(self, enumAsInt=0):
        """Button press type."""
        value = struct.unpack_from('B', self.rawBuffer(), SensorInterface_Buttons_Status.MSG_OFFSET + 0)[0]
        if not enumAsInt:
            value = SensorInterface_Buttons_Status.ReverseButtonPressType.get(value, value)
        return value
    ...
    def GetButtons(self, enumAsInt=0):
        """Bitfield of buttons pressed."""
        value = struct.unpack_from('B', self.rawBuffer(), SensorInterface_Buttons_Status.MSG_OFFSET + 1)[0]
        if not enumAsInt:
            value = SensorInterface_Buttons_Status.ReverseButtonID.get(value, value)
        return value
    ...
    def GetButtonGroup(self):
        """0 == earbud Master or non-earbud product; 1 == earbud Puppet"""
        value = struct.unpack_from('B', self.rawBuffer(), SensorInterface_Buttons_Status.MSG_OFFSET + 2)[0]
        return value
    ...
    def GetButtonDisabled(self):
        ...
        value = struct.unpack_from('B', self.rawBuffer(), SensorInterface_Buttons_Status.MSG_OFFSET + 3)[0]
        return value
    ...
    def GetButtonProcessStatus(self):
        ...
        value = struct.unpack_from('B', self.rawBuffer(), SensorInterface_Buttons_Status.MSG_OFFSET + 4)[0]
        return value
    ...
    def GetSupportedButtonIDs(self):
        ...
        value = struct.unpack_from('>H', self.rawBuffer(), SensorInterface_Buttons_Status.MSG_OFFSET + 5)[0]
        return value
    ...
    def SetType(self, value):
        ...
        if isinstance(value, int) or value.isdigit():
            defaultValue = int(value)
        value = SensorInterface_Buttons_Status.ButtonPressType.get(value, defaultValue)
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), SensorInterface_Buttons_Status.MSG_OFFSET + 0, tmp)
    ...
    def SetButtons(self, value):
        ...
        if isinstance(value, int) or value.isdigit():
            defaultValue = int(value)
        value = SensorInterface_Buttons_Status.ButtonID.get(value, defaultValue)
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), SensorInterface_Buttons_Status.MSG_OFFSET + 1, tmp)
    ...
    def SetButtonGroup(self, value):
        """0 == earbud Master or non-earbud product; 1 == earbud Puppet"""
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), SensorInterface_Buttons_Status.MSG_OFFSET + 2, tmp)
    ...
    def SetButtonDisabled(self, value):
        """1 == Button module disabled, button module does not respond to any button commands except sending BMAP status response; 0 == Button module enabled."""
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), SensorInterface_Buttons_Status.MSG_OFFSET + 3, tmp)
    ...
    def SetButtonProcessStatus(self, value):
        """0 == Button Ignored; 1 == Button Processed"""
        tmp = min(max(value, 0), 255)
        struct.pack_into('B', self.rawBuffer(), SensorInterface_Buttons_Status.MSG_OFFSET + 4, tmp)
    ...
    def SetSupportedButtonIDs(self, value):
        ...
        struct.pack_into('>H', self.rawBuffer(), SensorInterface_Buttons_Status.MSG_OFFSET + 5, tmp)
...
Messaging.Register("SensorInterface.Buttons.Status", SensorInterface_Buttons_Status.ID, SensorInterface_Buttons_Status)
